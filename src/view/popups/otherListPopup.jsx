import { ParentFormComponent, RunButton, UpdateButton, UploadButton, DelButton } from "flinntest-react-library";
...
export default class ISRandCampaignPopup extends BaseComponent{
    ...
    render(){
      ...
      if(this.app.state.popupSwitch.includes("update")){
        ...
        button = <UpdateButton obj={this.props.obj} content="Update" isPopup={true} callbackFunc={this.props.callbackFunc}/>
      }
        return(
        <div style={{padding:"10px", paddingBottom:"100px", height:"65%"}} className={this.props.pageClass||this.state.defaultClass}>
          ...
          <div className="popupButton" style={{width:"100%",}}>
            <div style={{paddingRight:"50px", paddingBottom:"20px"}}>
          <DelButton obj={this.app.state.currentPopupComponent} isPopup={true} content="Delete" callbackFunc={()=>{this.dispatch({popupSwitch:"", currentPopupComponent:undefined})}}/></div>
          </div>
    }
